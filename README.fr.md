...
- **Chronologie d'activité par app** — une bande par app montre quand elle a été active (par heure ou par jour) à partir de l'usage enregistré, pour faire ressortir l'activité en arrière-plan ou nocturne.
