...
struct JA4ParseTests {
    ...
    func parse() throws {
        let result = try TLSDissector.dissect(JA4ParseFixtures.clientHelloRecord(), at: 0, detailed: true)
    ...
    func truncated() throws {
        ...
        let result = try TLSDissector.dissect(Array(full.prefix(12)), at: 0, detailed: true)
